      ...
      <Container maxWidth="lg">
        <Box sx={{ my: 4 }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, alignItems: 'center' }}>
            <Box sx={{ display: 'flex', gap: 14, width: '100%', justifyContent: 'center' }}>
              {/* First row: 2 cards */}
              {[0, 1].map((idx) => (
                <Box key={idx} sx={{ flex: '1 1 416px', maxWidth: 520, minWidth: 364, display: 'flex' }}>
                  {(() => {
                    switch (idx) {
                      case 0:
                        return (
                          <Card sx={{ flex: 1, display: 'flex', flexDirection: 'column', width: '100%' }}>
                            <CardHeader title="Manage BD Users" titleTypographyProps={{ variant: 'h6' }} />
            ...
            <Box sx={{ display: 'flex', gap: 6, width: '100%', justifyContent: 'flex-start' }}>
              {/* Third row: 1 card, left aligned */}
              <Box sx={{ flex: '1 1 416px', maxWidth: 520, minWidth: 364, display: 'flex' }}>
                <Card sx={{ flex: 1, display: 'flex', flexDirection: 'column', width: '100%' }}>
                  ...
                  <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    <Button variant="contained" color="primary" disabled sx={{ mt: 'auto' }}>
